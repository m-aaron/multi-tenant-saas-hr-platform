...
The project documentation is organized into the following focused technical documents:

| Document                                                | Description                                                                     |
| ------------------------------------------------------- | ------------------------------------------------------------------------------- |
| **01 — Project Overview** _(this document)_             | Business domain, project goals, and overall scope                               |
